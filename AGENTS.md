# WARP.md - Working AI Reference for mcfly

## Project Overview
**Type**: Unknown/Debian Package
**Purpose**: > **Seeking co-maintainers**:
**Status**: Active
**Repository**: git@github.com:Vitexus/mcfly.git
...
git clone git@github.com:Vitexus/mcfly.git
cd mcfly
